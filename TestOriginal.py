...
num_train_imgs = len(os.listdir('data/Data/train_images/train/'))
num_val_images = len(os.listdir('data/Data/val_images/val/'))
...
MASK_HEIGHT = x_val.shape[1]
MASK_WIDTH  = x_val.shape[2]
MASK_CHANNELS = x_val.shape[3]
...
model.save('GoogleStaticSate_25_epochs_RESNET_backbone_batch08.hdf5')
